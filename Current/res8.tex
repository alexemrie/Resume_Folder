...
\end{changemargin} 
   \begin{itemize} \itemsep -2pt % reduce space between items
      \item Ship captain for APK delivering social experiences to Meta Quest VR devices.
      \item Principle engineer on internal tool used to root cause issues by synchronizing telemetry across tables.
      \item Led initiative for engineer POCs across org pillar to gather UX feedback and identify bugs prior to public release resulting in 50+ issues resolved per quarter.
      \item Migrated implementation for internal social dialogs resulting in 2x improvement in delivery cadence.
